            ...
            >
                ...
                <div class="block lg:flex items-center relative cursor-pointer">
                    ...
                    <div
                        ...
                        class="flex items-center mx-2"
                    >
                        <a :href="route('language', usePage().props.value.locale == 'ar' ? 'en' : 'ar')"><BaseIcon
                            v-if="menuItem.translation.icon"
                                                      :path="menuItem.translation.icon"
                                   class="transition-colors" /></a>
                        <span
                            class="px-2 transition-colors"
