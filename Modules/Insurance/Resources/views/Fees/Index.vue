...
function deleteItem() {
    Inertia.delete(route("fees.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/fees", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            @click.prevent="fireDelete(fee.id)"
                                        >
                                            <svg
                                                class="w-4 h-4"
        ...
        <Pagination :collection="fees.meta" class="mt-6" />
