...
function deleteItem() {
    Inertia.delete(route("company-fees.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/company-fees", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                    ...
                    >
                        ...
                        <tbody class="divide-y whitespace-nowrap">
                            <tr
                                ...
                                v-for="companyFee in companyFees.data"
                                :key="companyFee.id"
                            >
                                <td>{{ companyFee.id }}</td>
                                <td>{{ companyFee.company.name }}</td>
                                <td>{{ companyFee.fee.name }}</td>
                                <td>{{ companyFee.fees_amount }}</td>
                                <td>
                                    <div
                                        v-if="companyFee.is_percent"
        ...
        <Pagination :collection="companyFees.meta" class="mt-6" />
