...
function deleteItem() {
    Inertia.delete(route('companies.destroy', {id: deletedItemId}), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get('/admin/companies', pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                ...
                <div>
                    ...
                    >
                        ...
                        >
                            ...
                            <th class="filament-tables-header-cell">Name</th>
                                ...
                                <div class="flex items-center justify-end gap-4 my-4">
                                    <div>
                                        <Link
                                            ...
                                            href="#"
                                            @click.prevent="showViewModal(company)"
                                            preserve-scroll
                                            preserve-state
                                        >
                                    ...
                                    <button
                                        ...
                                        @click.prevent="fireDelete(company.id)"
                                    >
                                        <svg
                                            class="w-4 h-4"
        ...
        <Pagination :collection="companies.meta" class="mt-6"/>
