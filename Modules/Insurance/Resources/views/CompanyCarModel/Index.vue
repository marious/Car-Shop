...
function deleteItem() {
    Inertia.delete(route("company-car-models.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/company-car-models", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                    ...
                    >
                        <thead class="bg-gray-100 border-t border-b">
                            ...
                            >
                                ...
                                <th class="filament-tables-header-cell w-1/4">
                                    {{ __("Model") }}
                                </th>
                                <th class="filament-tables-header-cell">
                                    {{ __("Category") }}
                        ...
                        <tbody class="divide-y whitespace-nowrap">
                            <tr
                                ...
                                v-for="companyCarModel in companyCarModels.data"
                                :key="companyCarModel.id"
                            >
                                <!--                                <td>{{ companyCarModel.id }}</td>-->
                                <td>{{ companyCarModel.company.name }}</td>
                                <td>{{ companyCarModel.brand.name }}</td>
                                <td>
                                    <div
                                        style="
                                            display: flex;
                                    ...
                                    >
                                        <span
                                            v-for="model in companyCarModel.models"
                                            :key="model.id"
                                ...
                                <td>{{ companyCarModel.category }}</td>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <Component
                                                ...
                                                :href="
                                                    route(
                                                        'company-car-models.edit',
                                                        {
                                                            id: companyCarModel.id,
                                                        }
                                                    )
                                                "
                                                @click="
        ...
        <Pagination :collection="companyCarModels.meta" class="mt-6" />
