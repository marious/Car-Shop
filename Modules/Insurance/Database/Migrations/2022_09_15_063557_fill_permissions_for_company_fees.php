...
class FillPermissionsForCompanyFees extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompanyFees constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Company Fee Module' => 'company-fees',
            'List All Company Fee' => 'company-fees.index',
            'Create New Company Fee' => 'company-fees.create',
            'View Any Company Fee' => 'company-fees.show',
            'Edit or Update a Single Company Fee' => 'company-fees.edit',
            'Delete Company Fee' => 'company-fees.delete',
        ]);
