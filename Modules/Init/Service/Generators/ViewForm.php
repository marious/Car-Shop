...
class ViewForm extends ViewGenerator
{
     ...
     * @var string
     */
    protected $name = 'fb:generate:form';
    ...
    public function handle()
    {
        ...
        /*Make Create Form*/
        $viewPath = base_path('Modules/'.$this->moduleName.'/Resources/views'.'/Create.vue');

        if ($this->option('folder')) {
            $viewPath = base_path('Modules/'.$this->moduleName.'/Resources/views/'.  $this->option('folder').'/Create.vue');
        }
...
//        }
        //Make edit form
        $viewPath = base_path('Modules/'.$this->moduleName.'/Resources/views'.'/Edit.vue');

        if ($this->option('folder')) {
            $viewPath = base_path('Modules/'.$this->moduleName.'/Resources/views/'. $this->option('folder') .'/Edit.vue');
        }
...
//        $viewPath = resource_path('js/Pages/' . $this->modelPlural . '/EditForm.vue');
        ...
        //Make edit Page
        $viewPath = base_path('js/Pages/' . $this->modelPlural . '/Edit.vue');
        if ($this->alreadyExists($viewPath) && !$force) {
            $this->error('File ' . $viewPath . ' already exists!');
        } else {
            if ($this->alreadyExists($viewPath) && $force) {
