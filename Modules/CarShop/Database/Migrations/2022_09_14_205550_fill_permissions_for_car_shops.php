...
class FillPermissionsForCarShops extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarShops constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Car Shops Module' => 'car-shops',
            'List All Car Shops' => 'car-shops.index',
            'Create New Car Shops' => 'car-shops.create',
            'View Any Car Shop' => 'car-shops.show',
            'Edit or Update a Single Car Shop' => 'car-shops.edit',
            'Delete Car Shops' => 'car-shops.delete',
        ]);
