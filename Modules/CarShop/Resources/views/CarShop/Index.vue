...
function deleteItem() {
    Inertia.delete(route("car-shops.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/car-shops", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                    ...
                    >
                        ...
                        <tbody class="divide-y whitespace-nowrap">
                            <tr
                                ...
                                v-for="carShop in carShops.data"
                                :key="carShop.id"
                            >
                                <td>{{ carShop.id }}</td>
                                <td>{{ carShop.name }}</td>
                                <td>{{ carShop.commission }}</td>
                                    ...
                                    >
                                        ...
                                        <div>
                                            <Component
                                                ...
                                                :href="
                                                    route('car-shops.edit', {
                                                        id: carShop.id,
                                                    })
                                                "
                                                @click="
                                                    isModal
                                                        ? showEditModal(carShop)
                                                        : ''
                                                "
                                            >
                                                <i
        ...
        <Pagination :collection="carShops.meta" class="mt-6" />

        <DeleteModal
            title="Delete Car Shop"
            :show="deleteModal"
