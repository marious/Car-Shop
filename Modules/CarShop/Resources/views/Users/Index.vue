...
function deleteItem() {
    Inertia.delete(route("system-users.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/system-users", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            @click.prevent="fireDelete(user.id)"
                                        >
                                            <svg
                                                class="w-4 h-4"
        ...
        <Pagination :collection="users.meta" class="mt-6" />
