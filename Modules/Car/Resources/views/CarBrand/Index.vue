...
function deleteItem() {
    Inertia.delete(route("car-brands.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/car-brands", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                    ...
                    >
                        ...
                        <tbody class="divide-y whitespace-nowrap">
                            <tr
                                ...
                                v-for="carBrand in carBrands.data"
                                :key="carBrand.id"
                            >
                                <td>{{ carBrand.id }}</td>
                                <td>{{ carBrand.name }}</td>
        ...
        <Pagination :collection="carBrands.meta" class="mt-6" />
