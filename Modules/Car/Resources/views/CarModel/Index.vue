...
function deleteItem() {
    Inertia.delete(route("car-models.destroy", { id: deletedItemId }), {
...
watch(
    ...
    function () {
        debounce(function () {
            Inertia.get("/admin/car-models", pickBy(form.value), {
                preserveState: true,
            });
        }, 300)();
    },
...
<template>
    ...
    <div class="px-6 pt-6 mx-auto">
                    ...
                    >
                        ...
                        <tbody class="divide-y whitespace-nowrap">
                            <tr
                                ...
                                v-for="carModel in carModels.data"
                                :key="carModel.id"
                            >
                                <td>{{ carModel.id }}</td>
                                <td>{{ carModel.name }}</td>
        ...
        <Pagination :collection="carModels.meta" class="mt-6" />
