...
class FillPermissionsForCarBrands extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCarBrands constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'Car Brands Module' => 'car-brands',
            'List All Car Brands' => 'car-brands.index',
            'Create New Car Brands' => 'car-brands.create',
            'View Any Car Brand' => 'car-brands.show',
            'Edit or Update a Single Car Brand' => 'car-brands.edit',
            'Delete Car Brands' => 'car-brands.delete',
        ]);
